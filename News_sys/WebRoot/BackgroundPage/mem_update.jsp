...
#memUpdateForm label.error {
  ...
  <div class="container-fluid">
	<div class="row-fluid">
		<div class="span10">
			<form id="memUpdateForm" action="${pageContext.request.contextPath}/MemManagerServlet" method="post">
					 <legend>会员编辑</legend> 
					 <input type="hidden" name="nuid" value="${param.nuid}"/> 
                    <label>用户账号</label><input type="text"id="nuAccount" name="nuAccount"/><span id="err" style="font-size:18;color: red"></span>
                     ...
                     <br>
                      <input type="hidden" name="method" value="eidtMem">
